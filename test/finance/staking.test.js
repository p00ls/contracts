    ...
    describe('with staking plan', function () {
      ...
      describe('multi user', function () {
        ...
        it('scenario 1', async function () {
          ...
          await expect(this.xCreatorToken.connect(this.accounts.user1).redeem(this.xCreatorToken.balanceOf(this.accounts.user1.address), this.accounts.user1.address, this.accounts.user1.address))
          .to.emit(this.creatorToken, 'Transfer')
        ...
        it('scenario 3a', async function () {
          ...
          await expect(this.xCreatorToken.connect(this.accounts.user2).redeem(this.xCreatorToken.balanceOf(this.accounts.user2.address), this.accounts.user2.address, this.accounts.user2.address))
          .to.emit(this.creatorToken, 'Transfer')
